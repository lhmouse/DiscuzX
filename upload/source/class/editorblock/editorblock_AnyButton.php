...
class editorblock_AnyButton {

	var $version = '1.0.0';
	var $name = '按钮';
	var $available = 1; // 默认启用状态 0:不启用 1:启用
	var $columns = 1; //  默认是否支持多列 0:不支持 1:支持
	var $identifier = 'AnyButton';
	var $description = '按钮';
	var $filename = 'AnyButton';
		...
		return <<<EOF
{
    "type" : "AnyButton",
    "data" : {
          "link" : "https://addon.dismall.com/developer-32563.html",
          "text" : "云诺"
    }        
    "id": "ZT8S70Q34G", // 区块id
    "type": "AnyButton" // 区块类型
...
<div class="ce-block ce-block--focused" data-id="{id}" [if tunes.anchorTune.anchor=notnull]id="{tunes.anchorTune.anchor}"[/if]>
    <div class="ce-block__content">
        <div class="cdx-block">
            <div class="anyButtonContainer">
                <div class="anyButtonContainer__anyButtonHolder">
                	<a class="AnyButton-btn btn--default" target="_blank" rel="nofollow noindex noreferrer" href="{data.link}">{data.text}</a></div>
            </div>
        </div>
    </div>
</div>
