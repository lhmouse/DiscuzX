	...
	<div class="boxbody">
		<div class="stat_box cl">
			<div class="statitem ico01">{lang stats_main_members}
				...
				<span><a href="{ADMINSCRIPT}?action=members&operation=list" target="_blank">{echo number_format($statvars['members'])}</a></span>
			</div>
			...
			<div class="statitem ico03">{lang stats_main_posters}
				...
				<span><a href="{ADMINSCRIPT}?action=members&operation=list&posts_low=1" target="_blank">{echo number_format($statvars['mempost'])}</a></span>
			</div>
