...
<p>（正文完）</p>
	...
	'version_title' => '产品说明',
	'version_notice' => '
<p>- 基于 MitFrame<sup>&reg;</sup> 内核的全新框架体系重构</p>
<p>- 既是社区又是框架，全面开拓更广泛的开放视角</p>
<p>- 全面拥抱 OAuth2.0 的 RESTful API 接口，开发者可随意自定义自己的接口</p>
<p>- 基于 WitFrame<sup>&reg;</sup> 云平台的云插件体系</p>
<p>- 内核级第三方登录接入、内核级支付接入、内核级多国语言接入</p>
<p><a href="https://www.dismall.com/thread-18472-1-1.html" target="_blank">点击了解更多...</a></p>

<p>X5.0 开发者预览版仅在 <a href="https://gitee.com/Discuz/DiscuzX/tree/MitFrame" target="_blank">Discuz! X5.0 官方 Git</a> 发布，请不要在其他网站下载</p>

<p>本预览版仅限开发者提前为站长开发适配 X5.0 和 W1.5 版应用而设计，正常运营的 X3.5 社区请勿安装、升级，可供普通站长使用的版本尚未发布，请勿随意尝鲜。在开发者们未跟进 X5.0 应用前，盲目升级会导致无法安装任何应用，还会产生未知问题，但是如果您想体验 X5.0 版 Discuz! 可开通 <a href="https://w.discuz.vip" target="_blank">Discuz!ᵂ SaaS</a> 版 Discuz! 试用</p>

<p>- X5.0 起 Discuz! 默认不再包含 UCenter 服务端，如需站群方式部署请自行下载 <a href="https://gitee.com/Discuz/UCenter" target="_blank">UCenter</a></p>
<p>- X5.0 起安装程序默认内置升级程序</p>
<p>- X5.0 将不再兼容 PHP 7，安装、升级前请自行准备 PHP 8 环境</p>
<p>- X5.0 兼容 X3.5 应用的运行，但是在未完全适配好 PHP 8 前，我们不建议开发者擅自修改兼容标识</p>
<p>- X5.0 新增了诸多 App、插件、模板的新特性(<a href="https://open.dismall.com/?ac=document&page=dev_x5_index" target="_blank">点此查看 X5.0 开发技术文档</a>)，只有使用了新特性的应用才算 100% 兼容 X5.0</p>
<p>- 本版本内置 sample 插件、sample 模版、sample App 扩展的所有范例源码，请配合技术文档学习</p>
<p>- 有任何开发、使用方面的问题请直接在<a href="https://www.dismall.com/forum-mitframe-1.html" target="_blank">开发者预览版官方讨论区</a>发帖，本版块仅限绑定了应用中心开发者账号的开发者进入。官方人员不解答在其他版块的 X5.0 相关问题</p>
<p>- 欢迎 D 粉们积极 PR，Discuz! 24 年，开源产品少不了大家的支持</p>
',
	...
	<li>如旧版本应用涉及其他目录中的文件，请自行咨询相关开发者复制；</li>
	</ul>
	',
