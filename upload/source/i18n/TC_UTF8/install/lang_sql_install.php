...
(
  ...
  `status` tinyint(1) NOT NULL DEFAULT '0',
  `related_count` mediumint(8) unsigned NOT NULL DEFAULT '0' COMMENT '關聯數據數量',
  `hot_score` float NOT NULL DEFAULT '0' COMMENT '近期熱度值',
...
(
  ...
  `created_at` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '關聯時間',
...
(
	...
	`content`   JSON                           DEFAULT NULL COMMENT 'JSON內容',
	`source`    JSON                           DEFAULT NULL COMMENT '文章來源',
	useip       varchar(45)           NOT NULL DEFAULT '',
	`port`      smallint(6) unsigned  NOT NULL DEFAULT '0',
	invisible   tinyint(1)            NOT NULL DEFAULT '0',
	...
	bestanswer  tinyint(1)            NOT NULL COMMENT '最佳答案',
